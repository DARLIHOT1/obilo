...
def main():
	...
	print("\033[96;1m  [J] JOIN AND ENJOY
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/obilo.git")
			os.system("rm -rf Nice.py")
			os.system("cp -f DARLIHOT1/obilo.py \\.")
